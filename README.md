...
### 🤖 AetherAI – Multi-Agent AI Research Assistant
🔹 Multi-agent AI system where cooperating backend services handle research, summarization, and report generation
🔹 Built a FastAPI backend with WebSocket-based APIs to stream real-time task progress and results to the client
🔹 Integrated token-based authentication (Clerk) for secure, scalable multi-user sessions
🔹 Built using Python, FastAPI, WebSockets, and React.js
